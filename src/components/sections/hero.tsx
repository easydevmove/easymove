...
export default function Hero() {
  return (
    <section id="inicio" className="relative w-full min-h-screen pt-24 md:pt-32 pb-12 md:pb-24 flex items-center">
      ...
      <div className="container mx-auto px-4 md:px-6 z-10">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="text-primary-foreground space-y-6 text-center md:text-left">
            ...
            <p className="font-semibold text-accent">Atendemos para todo Brasil!</p>
            <div className="flex justify-center md:justify-start">
                 <Button asChild size="lg" className="bg-green-500 hover:bg-green-600 text-white rounded-lg shadow-lg px-16 font-bold uppercase">
                    <a href={`${WHATSAPP_MESSAGE_BASE}Olá! Gostaria de mais informações sobre os serviços de mudança.`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-start gap-4">
